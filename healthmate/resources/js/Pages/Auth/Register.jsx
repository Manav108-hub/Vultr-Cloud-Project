...
export default function Register() {
    ...
    return (
            <section className="bg-gray-50 flex justify-center items-center p-8">
                <Head title="Register" />
                    <div
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    ...
                                    <input type="text" name="full-name" id="full-name" value={form.full_name}
                                ...
                                <div>
                                    <label htmlFor="date"
                                        ...
                                        of Birth</label>
                                    <input type="date" name="dob" id="dob" value={form.birth_date}
