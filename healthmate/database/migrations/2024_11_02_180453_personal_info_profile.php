...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('user_health_details', function (Blueprint $table) {
            ...
            $table->uuid('healthmate_user_id'); // Connects to healthmate_user table
            ...
            $table->foreign('healthmate_user_id')->references('id')->on('healthmate_users')->onDelete('cascade');
        });
        ...
        Schema::create('activities', function (Blueprint $table) {
            $table->uuid('id')->primary(); // UUID as primary key
            $table->uuid('user_health_details_id'); // Connects to user_health_details table
